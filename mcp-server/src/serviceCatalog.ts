...
export const SERVICE_CATALOG: Record<string, ServiceInfo> = {
  ...
  'Foundry Tools':          { displayName: 'Foundry Tools',          aliases: ['Azure AI Services', 'Azure Cognitive Services', 'Cognitive Services', 'Cognitive Service'], category: 'ai + machine learning', hasPricingData: true, pricingServiceName: 'Cognitive Services', isUsageBased: true, costRange: '$0-500/mo' },
  ...
  'Azure AI Document Intelligence': { displayName: 'Azure AI Document Intelligence', aliases: ['Document Intelligence', 'Form Recognizer', 'Azure Form Recognizer', 'Azure Document Intelligence', 'Form Processing'], category: 'ai + machine learning', hasPricingData: true, pricingServiceName: 'Document Intelligence', isUsageBased: true, costRange: '$0-500/mo' },
  ...
  'Azure AI Search':        { displayName: 'Azure AI Search',        aliases: ['Azure Cognitive Search', 'Cognitive Search', 'Azure Search', 'AI Search'], category: 'ai + machine learning', hasPricingData: false, costRange: '$75-2500/mo' },
  ...
  'Functions':              { displayName: 'Azure Functions',        aliases: ['Function App', 'Functions', 'Azure Functions', 'Serverless Functions'],             category: 'compute', hasPricingData: true, pricingServiceName: 'Functions', isUsageBased: true, costRange: '$0-160/mo' },
  ...
  'Azure Health Data Services FHIR service': { displayName: 'Azure Health Data Services FHIR service', aliases: ['Azure API for FHIR', 'FHIR', 'FHIR Service', 'Azure Health Data Services FHIR', 'Azure FHIR service'], category: 'integration', hasPricingData: false, isUsageBased: true, costRange: '$0-3000/mo' },
