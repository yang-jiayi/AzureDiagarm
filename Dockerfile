...
ARG VITE_AZURE_FOUNDRY_ENDPOINT
ARG VITE_AZURE_FOUNDRY_DEPLOYMENT_CLAUDE_OPUS5
...
ARG VITE_ARM_SCOPE
ARG VITE_FEEDBACK_CONTACT_ENABLED=false
...
ENV VITE_AZURE_FOUNDRY_ENDPOINT=$VITE_AZURE_FOUNDRY_ENDPOINT
ENV VITE_AZURE_FOUNDRY_DEPLOYMENT_CLAUDE_OPUS5=$VITE_AZURE_FOUNDRY_DEPLOYMENT_CLAUDE_OPUS5
...
ENV VITE_FEEDBACK_CONTACT_ENABLED=$VITE_FEEDBACK_CONTACT_ENABLED
