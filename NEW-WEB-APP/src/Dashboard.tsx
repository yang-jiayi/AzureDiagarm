  ...
  return <section className="wide-grid">
    <Panel eyebrow="Success moment" title="Validation handoff">
      <div className="handoff-metrics">
        <article><span>Handoff shown</span><strong>{handoff.shown.toLocaleString()}</strong><small>Initial-generation sessions</small></article>
        <article><span>Validation started</span><strong>{handoff.started.toLocaleString()}</strong><small>Sessions selecting the CTA</small></article>
        <article><span>Dismissed</span><strong>{handoff.dismissed.toLocaleString()}</strong><small>Sessions choosing Not now</small></article>
        <article><span>Start rate</span><strong>{handoff.startRate}%</strong><small>Started sessions / shown sessions</small></article>
      </div>
    </Panel>
