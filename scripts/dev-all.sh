...
if [ -n "${AZURE_OPENAI_ENDPOINT:-}" ]; then
  ok "Managed GPT-6 Astra endpoint configured; BYO connections: $ALLOW_BYO_AI_ENDPOINTS"
else
  warn "Managed GPT-6 Astra is unconfigured; BYO connections: $ALLOW_BYO_AI_ENDPOINTS"
fi
