...
function bicepHeader(passwordParameters: DatabasePasswordParameter[]): string {
  const lines = [
    ...
    ``,
    `// Design-time starter generated by Azure Architecture Diagram Builder.`,
  ...
  lines.push(
    ``,
    `var commonTags = {`,
    `  generatedBy: 'Azure Architecture Diagram Builder'`,
...
function terraformHeader(passwordParameters: DatabasePasswordParameter[]): string {
  ...
  lines.push(
    ...
    `locals {`,
    `  common_tags = {`,
    `    generated_by    = "Azure Architecture Diagram Builder"`,
